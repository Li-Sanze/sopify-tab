...
| 项 | 结果 | 说明 |
|---|---|---|
| 视口 600 单栏 | 通过 | 「见 PR 评论」（600×900）。三列 top 为 388 / 604 / 820，`grid-template-columns` 为一条 `532.317px`。 |
...
| 空态无全框焦点描边 | 通过 | 「见 PR 评论」。拍前 blur，activeElement 为 BODY，输入框 outline 与 box-shadow 均为 none，只剩底边线。 |
